...
const AGENT_REGISTRY: SkillEntry[] = [
  {
    triggers: ['nodejs', 'express', 'nextjs-app', 'nextjs-pages', 'nestjs', 'fastapi', 'rails', 'typescript', 'prisma', 'postgresql', 'mongodb', 'go', 'python', 'django', 'rust', 'bun', 'php'],
    files: [AGENT_BACKEND],
  },
  {
